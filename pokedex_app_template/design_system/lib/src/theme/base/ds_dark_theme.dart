...
final ThemeData _darkThemeData = ThemeData.dark().copyWith(
  ...
  ///do tema escuro,incluindo as cores de fundo, cores do texto e estilos
  ///dos ícones.
...
///personalizados, incluindo cores, estilos de texto e estilos de botões.
///Ele faz parte de um arquivo de definição de tema mais amplo (ds_theme.dart)
