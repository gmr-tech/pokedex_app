...
final ThemeData _lightThemeData = ThemeData.light().copyWith(
  ...
  ///do tema claro, incluindo as cores de fundo, cores do texto e estilos dos
  ///ícones.
  ...
  /// (ElevatedButton) para o tema claro. Ele especifica a cor de fundo e a
  /// cor do texto com base no estado do botão
  /// (por exemplo, desabilitado, pressionado).
...
///esse arquivo define um esquema de cores e um conjunto de dados de
///tema claro personalizados, incluindo cores, estilos de texto e
///estilos de botões. Ele faz parte de um arquivo de definição
/// de tema mais amplo (ds_theme.dart) usado para personalizar
/// a aparência da aplicação em um tema claro.
