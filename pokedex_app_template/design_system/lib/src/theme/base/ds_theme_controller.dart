...
class DSThemeController extends ChangeNotifier {
  ...
  /// representado por um enum DSThemeMode que possui dois valores possíveis:
  /// light (claro) e dark (escuro).
  DSThemeMode get dsThemeMode => _dsThemeMode;

  ///themeMode: Um getter para obter o ThemeMode atual, que é um enum do Flutter
  ///ue representa o modo de tema do Flutter. Pode ser ThemeMode.light (claro),
  ///ThemeMode.dark (escuro).
  ThemeMode get themeMode => _themeMode;

  ///themeData: Um getter para obter os dados de tema do Flutter correspondentes
  ///ao modo de tema atual.
  ThemeData get themeData => _themeData;

  ///dsThemeMode: Um setter para definir o modo de tema. Ele atualiza
  ///internamente o modo de tema, os dados de tema do Flutter
  ///e notifica os ouvintes sobre a alteração.
  ...
  ///_toggleThemeMode(DSThemeMode newMode): Um método privado que atualiza o
  ///_themeMode com base no DSThemeMode fornecido.
  ...
  ///_toggleThemeData(DSThemeMode newMode): Um método privado que atualiza o
  ///_themeData com base no DSThemeMode fornecido.
