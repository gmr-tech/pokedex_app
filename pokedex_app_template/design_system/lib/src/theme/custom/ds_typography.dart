...
///pacote theme_tailor usado no projeto para facilitar a personalização e ajuste
///do tema. O pacote theme_tailor utiliza essa anotação para identificar os
///componentes que podem ser personalizados e gerar o código correspondente para
///cada tema.

///Portanto, a anotação @TailorComponent(themes: ['light', 'dark']) indica que a
///classe DSTypography é um componente personalizável do tema e que existem dois
