...
///O arquivo inclui diretivas part para indicar que o código é dividido
///em partes e essas partes estão incluídas em outros arquivos.
part 'ds_color.dart';
part 'ds_custom_theme.tailor.dart';
part 'ds_typography.dart';

//Classe responsável por agrupar e fornecer acesso aos elementos de
//personalização do tema, como cores e estilos de tipografia,
//que foram definidas no arquivo ds_color.dart e ds_typography.dart
@tailor
class _$DSCustomTheme {
  ///extende ThemeExtension, indicando que é uma extensão do
...
///ds_custom_theme.dart tem a função de definir e encapsular as configurações
///e elementos de personalização do tema em uma classe centralizada
///(DSCustomTheme), permitindo que o tema seja facilmente acessado e
/// aplicado no applicativo inteiro.
